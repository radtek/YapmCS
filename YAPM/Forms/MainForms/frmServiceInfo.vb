...
Public Class frmServiceInfo
    ...
    Private Sub cmdStop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStop.Click
        If WarnDangerousAction("Are you sure you want to stop this service ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        curServ.StopService()
    End Sub
    ...
    Private Sub cmdSetStartType_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSetStartType.Click
        If WarnDangerousAction("Are you sure you want to change the type of start ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        If _notWMI Then
            If WarnDangerousAction("Are you sure you want to delete this service ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
                Exit Sub
            End If

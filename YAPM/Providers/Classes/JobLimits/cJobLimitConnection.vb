...
Public Class cJobLimitConnection
    ...
    Public Sub New(ByVal ControlWhichGetInvoked As Control, ByRef Conn As cConnection, ByRef de As HasEnumeratedEventHandler)
        ...
        _jobEnumLimits = New asyncCallbackJobLimitsEnumerate(_control, de, Me, _instanceId)
    End Sub
...
#Region "Events, delegate, invoke..."
    ...
    Public Delegate Sub HasEnumeratedEventHandler(ByVal Success As Boolean, ByVal Dico As Dictionary(Of String, jobLimitInfos), ByVal errorMessage As String, ByVal instanceId As Integer)
...
#Region "Enumerate job limits"

    ' Enumerate jobs
    Public Function Enumerate(ByVal jobName As String, Optional ByVal forInstanceId As Integer = -1) As Integer
        Call Threading.ThreadPool.QueueUserWorkItem(New  _
                System.Threading.WaitCallback(AddressOf _
                _jobEnumLimits.Process), New  _
                asyncCallbackJobLimitsEnumerate.poolObj(jobName, forInstanceId))
    End Function

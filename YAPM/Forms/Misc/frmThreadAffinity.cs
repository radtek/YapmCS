...
public partial class frmThreadAffinity
{
    private cThread[] threads;

    public cThread[] Thread
    {
        set
        {
            threads = value;
    ...
    private void frmProcessAffinity_Load(System.Object sender, System.EventArgs e)
    {
        ...
        int _procCount = Program.SystemInfo.ProcessorCount - 1;
        ...
        else
        {
            ...
            int m = threads[0].Infos.AffinityMask.ToInt32();
            ...
            int m1 = Native.Objects.Process.CurrentProcesses[threads[0].Infos.ProcessId.ToString()].Infos.AffinityMask.ToInt32();
            Native.Objects.Process.SemCurrentProcesses.Release();
            this.chk0.Enabled = ((m1 & 1) == 1);
            this.chk1.Enabled = ((m1 & 2) == 2);
            this.chk2.Enabled = ((m1 & 4) == 4);
            this.chk3.Enabled = ((m1 & 8) == 8);
            this.chk4.Enabled = ((m1 & 16) == 16);
            this.chk5.Enabled = ((m1 & 32) == 32);
            this.chk6.Enabled = ((m1 & 64) == 64);
            this.chk7.Enabled = ((m1 & 128) == 128);
            this.chk8.Enabled = ((m1 & 256) == 256);
            this.chk9.Enabled = ((m1 & 512) == 512);
            this.chk10.Enabled = ((m1 & 1024) == 1024);
            this.chk11.Enabled = ((m1 & 2048) == 2048);
            this.chk12.Enabled = ((m1 & 4096) == 4096);
            this.chk13.Enabled = ((m1 & 14) == 8192);
            this.chk14.Enabled = ((m1 & 15) == 16384);
            this.chk15.Enabled = ((m1 & 16) == 32768);
            this.chk16.Enabled = ((m1 & 17) == 65536);
            this.chk17.Enabled = ((m1 & 18) == 131072);
            this.chk18.Enabled = ((m1 & 19) == 262144);
            this.chk19.Enabled = ((m1 & 20) == 524288);
            this.chk20.Enabled = ((m1 & 21) == 1048576);
            this.chk21.Enabled = ((m1 & 22) == 2097152);
            this.chk22.Enabled = ((m1 & 23) == 4194304);
            this.chk23.Enabled = ((m1 & 24) == 8388608);
            this.chk24.Enabled = ((m1 & 25) == 16777216);
            this.chk25.Enabled = ((m1 & 26) == 33554432);
            this.chk26.Enabled = ((m1 & 27) == 67108864);
            this.chk27.Enabled = ((m1 & 28) == 134217728);
            this.chk28.Enabled = ((m1 & 29) == 238435456);
            this.chk29.Enabled = ((m1 & 30) == 536870912);
            this.chk30.Enabled = ((m1 & 31) == 1073741824);
            this.chk31.Enabled = ((m1 & 32) == 2147483648);
        }
    }

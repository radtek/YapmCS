...
Public Class frmScripting
    ...
    Private Sub frmScripting_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If _saved = False AndAlso Me.rtb.TextLength > 0 Then
            ...
            If Misc.ShowMsg("Exit", "Current script is unsaved", "Are you sure you want to exit without saving the file ?", MessageBoxButtons.YesNo, TaskDialogIcon.Information) <> System.Windows.Forms.DialogResult.Yes Then
                e.Cancel = True
                Exit Sub
            End If
        End If
    ...
    Private Sub cmdOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOpen.Click
        ...
        If _saved OrElse Me.rtb.TextLength = 0 Then
            ...
            With Me.OpenFileDialog
                ...
                If rep = System.Windows.Forms.DialogResult.OK Then
                    sFile = .FileName
                    Try
        ...
        Else
            ...
            If Misc.ShowMsg("Open a new script", "", "Do you want to save the current script ?", MessageBoxButtons.YesNo, TaskDialogIcon.Information) = System.Windows.Forms.DialogResult.Yes Then
                Call Me.cmdSave_Click(Nothing, Nothing)
            End If
        End If
    End Sub

...
#End If
    ...
    Private Sub butKill_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butKillProcess.Click
        If WarnDangerousAction("Are you sure you want to kill these processes ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub butStopProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butStopProcess.Click
        If WarnDangerousAction("Are you sure you want to suspend these processes ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cProcess In Me.lvProcess.GetSelectedItems
            it.SuspendProcess()
    ...
    Private Sub butOpenFile_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butOpenFile.Click
        ...
        If openDial.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ...
            Try
                ...
                If FileLen(file) > 2000000 Then
                    If Misc.ShowMsg("Show file strings", _
                                    ...
                                    True) = System.Windows.Forms.DialogResult.No Then
    ...
    Private Sub butTaskEndTask_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles butTaskEndTask.Click
        ' Close task
        If WarnDangerousAction("Are you sure you want to terminate these tasks ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cTask In Me.lvTask.GetSelectedItems
            it.Close()
    ...
    Private Sub MenuItemSearchClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemSearchClose.Click
        ...
        If WarnDangerousAction("This will close handles, unload module, stop service, kill process or close window depending on the selected object.", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cSearchItem In Me.lvSearchResults.GetSelectedItems
            it.CloseTerminate()
...
#End Region
    ...
    Private Sub MenuItemJobTerminate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MenuItemJobTerminate.Click
        If WarnDangerousAction("Are you sure you want to terminate these jobs ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If

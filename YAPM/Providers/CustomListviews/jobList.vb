...
Public Class jobList
    ...
    Public Event ItemAdded(ByRef item As cJob)
    Public Event ItemDeleted(ByRef item As cJob)
    ...
    Private _dicoNew As New Dictionary(Of String, cJob)
    Private _dicoDel As New Dictionary(Of String, cJob)
    Private _buffDico As New Dictionary(Of String, cJob)
    Private _dico As New Dictionary(Of String, cJob)
    Private WithEvents _connectionObject As New cConnection
    Private WithEvents _jobConnection As New cJobConnection(Me, _connectionObject, New cJobConnection.HasEnumeratedEventHandler(AddressOf HasEnumeratedEventHandler))
...
#End Region
    ...
    Public Overrides Sub UpdateItems()
        ...
        If _jobConnection.IsConnected Then
            ...
            ' Now enumerate items
            _jobConnection.Enumerate(_first)
    ...
    Private Sub HasEnumeratedEventHandler(ByVal Success As Boolean, ByVal Dico As Dictionary(Of String, jobInfos), ByVal errorMessage As String, ByVal instanceId As Integer)
        ...
        If Success = False Then
            ...
            RaiseEvent GotAnError("Job connection enumeration", errorMessage)
            generalLvSemaphore.Release()
            Exit Sub
        End If
        ...
        For Each z As cJob In _dico.Values
        ...
        For Each z As String In _dicoNew.Keys
            Dim _it As cJob = _dicoNew.Item(z)

...
Public Class frmThreadAffinity
    ...
    Public WriteOnly Property Thread() As cThread()
        Set(ByVal value As cThread())
            threads = value
        End Set
    End Property
    ...
    Private Sub frmProcessAffinity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Dim m1 As Integer = Native.Objects.Process.CurrentProcesses.Item(threads(0).Infos.ProcessId.ToString).Infos.AffinityMask.ToInt32
            ...
            Me.chk3.Enabled = ((m1 And 8) = 8)
            Me.chk4.Enabled = ((m1 And 16) = 16)
            Me.chk5.Enabled = ((m1 And 32) = 32)
            Me.chk6.Enabled = ((m1 And 64) = 64)
            Me.chk7.Enabled = ((m1 And 128) = 128)
            Me.chk8.Enabled = ((m1 And 256) = 256)
            Me.chk9.Enabled = ((m1 And 512) = 512)
            Me.chk10.Enabled = ((m1 And 1024) = 1024)
            Me.chk11.Enabled = ((m1 And 2048) = 2048)
            Me.chk12.Enabled = ((m1 And 4096) = 4096)
            Me.chk13.Enabled = ((m1 And 14) = 8192)
            Me.chk14.Enabled = ((m1 And 15) = 16384)
            Me.chk15.Enabled = ((m1 And 16) = 32768)
            Me.chk16.Enabled = ((m1 And 17) = 65536)
            Me.chk17.Enabled = ((m1 And 18) = 131072)
            Me.chk18.Enabled = ((m1 And 19) = 262144)
            Me.chk19.Enabled = ((m1 And 20) = 524288)
            Me.chk20.Enabled = ((m1 And 21) = 1048576)
            Me.chk21.Enabled = ((m1 And 22) = 2097152)
            Me.chk22.Enabled = ((m1 And 23) = 4194304)
            Me.chk23.Enabled = ((m1 And 24) = 8388608)
            Me.chk24.Enabled = ((m1 And 25) = 16777216)
            Me.chk25.Enabled = ((m1 And 26) = 33554432)
            Me.chk26.Enabled = ((m1 And 27) = 67108864)
            Me.chk27.Enabled = ((m1 And 28) = 134217728)
            Me.chk28.Enabled = ((m1 And 29) = 238435456)
            Me.chk29.Enabled = ((m1 And 30) = 536870912)
            Me.chk30.Enabled = ((m1 And 31) = 1073741824)
            Me.chk31.Enabled = ((m1 And 32) = 2147483648)
        End If

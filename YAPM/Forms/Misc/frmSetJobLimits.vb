...
Public Class frmSetJobLimits
    ...
    Private Sub cmdCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSetLimits.Click
        If setLimits() = System.Windows.Forms.DialogResult.OK Then
...
#End Region
    ...
    Private Function setLimits() As DialogResult
        ...
        ' Set limit
        If WarnDangerousAction("Are you sure you want to set the limits you specified ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then

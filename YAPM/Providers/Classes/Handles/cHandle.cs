...
public class cHandle : cGeneralObject
{
    private handleInfos _handleInfos;
    private static cHandleConnection __connection;

    private static cHandleConnection _connection
    {
    ...
    public static cHandleConnection Connection
    {
        get
        {
            return _connection;
    ...
    public cHandle(ref handleInfos infos)
    {
        _handleInfos = infos;
    ...
    public void Merge(ref handleInfos Thr)
    {
        _handleInfos.Merge(ref Thr);
    }
    ...
    {
        if (_closeH == null)
            _closeH = new asyncCallbackHandleUnload(new asyncCallbackHandleUnload.HasUnloadedHandle(unloadHandleDone), ref _connection);
        ...
        System.Threading.ThreadPool.QueueUserWorkItem(t, new asyncCallbackHandleUnload.poolObj(this.Infos.ProcessId, this.Infos.Handle, newAction));
    }
    ...
    public override string GetInformation(string info)
    {
        ...
        switch (info)
        {
            ...
            case "PointerCount":
                {
                    res = this.Infos.PointerCount.ToString();
                    break;
                }

            case "ObjectCount":
                {
                    res = this.Infos.ObjectCount.ToString();
                    break;
                }
            ...
            case "ObjectAddress":
                {
                    res = "0x" + this.Infos.ObjectAddress.ToString("x");
                    break;
                }

            case "GrantedAccess":
                {
                    res = "0x" + this.Infos.GrantedAccess.ToString("x");
                    break;
                }

            case "Attributes":
                {
                    res = this.Infos.Attributes.ToString();
                    break;
                }

            case "CreateTime":
                {
                    res = this.Infos.CreateTime.ToString();
                    break;
                }

            case "PagedPoolUsage":
                {
                    res = this.Infos.PagedPoolUsage.ToString();
                    break;
                }

            case "NonPagedPoolUsage":
                {
                    res = this.Infos.NonPagedPoolUsage.ToString();
                    break;
                }

            case "ObjectTypeNumber":
                {
                    res = this.Infos.ObjectTypeNumber.ToString();
                    break;
                }
        }
 ...
 */
    ...
    private static asyncCallbackHandleUnload _sharedcloseH;
    public static int SharedLRCloseHandle(int pid, IntPtr handle)
    {
        if (_sharedcloseH == null)
            _sharedcloseH = new asyncCallbackHandleUnload(new asyncCallbackHandleUnload.HasUnloadedHandle(unloadsharedHandleDone), ref _connection);

        System.Threading.WaitCallback t = new System.Threading.WaitCallback(_sharedcloseH.Process());
        int newAction = cGeneralObject.GetActionCount();

        System.Threading.ThreadPool.QueueUserWorkItem(t, new asyncCallbackHandleUnload.poolObj(pid, handle, newAction));

        AddSharedPendingTask(newAction, ref t);
    }
    private static void unloadsharedHandleDone(bool Success, int pid, IntPtr handle, string msg, int actionNumber)
    {
        if (Success == false)
            Misc.ShowError("Could not unload handle " + handle.ToString() + " : " + msg);

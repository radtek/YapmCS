...
Public Class frmProcessInfo
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Try
            If _frmMain.saveDial.ShowDialog = System.Windows.Forms.DialogResult.OK Then
    ...
    Private Sub cmdKill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdKill.Click
        If WarnDangerousAction("Are you sure you want to kill this process ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        Call curProc.Kill()
    End Sub
    ...
    Private Sub cmdPause_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPause.Click
        If WarnDangerousAction("Are you sure you want to suspend this process ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub MenuItem9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuCloseTCP.Click
        If WarnDangerousAction("Are you sure you want to close these connections ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub MenuItemCloseHandle_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemCloseHandle.Click
        If WarnDangerousAction("Are you sure you want to close these handles ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub MenuItemPriRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemPriRemove.Click
        If WarnDangerousAction("Are you sure you want to remove this privilege ?" & vbNewLine & "This is a permanent action for all process lifetime.", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cPrivilege In Me.lvPrivileges.GetSelectedItems
    ...
    Private Sub MenuItemUnloadModule_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemUnloadModule.Click
        If WarnDangerousAction("Are you sure you want to unload these modules ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cModule In Me.lvModules.GetSelectedItems
            it.UnloadModule()
    ...
    Private Sub MenuItemServStop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemServStop.Click
        If WarnDangerousAction("Are you sure you want to stop these services ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cService In Me.lvProcServices.GetSelectedItems
            it.StopService()
    ...
    Private Sub MenuItemThTerm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemThTerm.Click
        If WarnDangerousAction("Are you sure you want to terminate these threads ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
    ...
    Private Sub MenuItemThSuspend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemThSuspend.Click
        If WarnDangerousAction("Are you sure you want to suspend these threads ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cThread In Me.lvThreads.GetSelectedItems
            it.ThreadSuspend()
    ...
    Private Sub MenuItemWClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemWClose.Click
        If WarnDangerousAction("Are you sure you want to close these windows ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cWindow In Me.lvWindows.GetSelectedItems
            it.Close()
...
#End Region
    ...
    Private Sub MenuItemMemoryDump_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemMemoryDump.Click
        ...
        Using chooseF As New System.Windows.Forms.FolderBrowserDialog
    ...
    Private Sub MenuItemMemoryRelease_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemMemoryRelease.Click
        If WarnDangerousAction("Are you sure you want to release these memory regions ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cMemRegion In Me.lvProcMem.GetSelectedItems
            it.Release()
...
#End Region
    ...
    Private Sub MenuItemServDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItemServDelete.Click
        If WarnDangerousAction("Are you sure you want to delete these services ?", Me.Handle) <> System.Windows.Forms.DialogResult.Yes Then
            Exit Sub
        End If
        For Each it As cService In Me.lvProcServices.GetSelectedItems
            it.DeleteService()
